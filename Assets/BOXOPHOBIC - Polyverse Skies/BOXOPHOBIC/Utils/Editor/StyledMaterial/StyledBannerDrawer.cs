...
namespace Boxophobic.StyledGUI
{
    public class StyledBannerDrawer : MaterialPropertyDrawer
    {
        ...
        void DrawBanner(Shader shader)
        {
            ...
            var bannerMiddleRect = new Rect(bannerFullRect.position.x + 20, bannerFullRect.position.y,
                bannerFullRect.xMax - 54, 40);
            ...
            GUI.Label(bannerFullRect,
                "<color=#" + ColorUtility.ToHtmlStringRGB(guiColor) + "><size=16>" + title + "</size><size=14>" + " " +
                subtitle + "</size></color>", CONSTANT.TitleStyle);
#else
