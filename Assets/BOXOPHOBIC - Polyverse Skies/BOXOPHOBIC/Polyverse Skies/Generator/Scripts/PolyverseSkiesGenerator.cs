...
namespace PolyverseSkies
{
    ...
    public class PolyverseSkiesGenerator : StyledMonoBehaviour
    {
        [StyledBanner(0.968f, 0.572f, 0.890f, "Cubemap Generator", "",
            "https://docs.google.com/document/d/1z7A_xKNa2mXhvTRJqyu-ZQsAtbV32tEZQbO1OmPS_-s/edit#heading=h.8h46nz99pbdp")]
        public bool styledBanner;

        [StyledMessage("Info",
            "The cubemap generator will render the scene skybox to a static cubemap that can be used with a simple cubemap skybox shader! The generated cubemap will be saved to the Assets folder.")]
        public bool messageSkybox = false;

        [StyledMessage("Info",
            "The cubemap generator will render the clouds to a cubemap. Change the child particles to generate new patterns. The generated cubemap will be saved to the Assets folder. Once generated, you will get a realtime preview in the scene.")]
        public bool messageClouds = false;

        [Space(10)] public CubemapType cubemapType = CubemapType.CloudsCubemap;
        public CubemapSizes cubemapSize = CubemapSizes._2048;

        [Space(10)] [StyledButton("Generate Cubemap", "")]
        public bool generateCubemap = false;

        [StyledSpace(10)] public bool styledSpace0;
        ...
        void Update()
        {
            ...
            if (generateCubemap)
            {
                ...
                Cubemap cubemap = new Cubemap((int)cubemapSize,
                ...
                for (int i = 0; i < (int)cubemapSize; i++)
                {
                    for (int j = 0; j < (int)cubemapSize; j++)
                    {
                        ...
                        img.SetPixel(i + (int)cubemapSize, j,
                            new Color(pixelColor.r, pixelColor.g, pixelColor.b, pixelValue));
                    }
                }
                ...
                for (int i = 0; i < (int)cubemapSize; i++)
                {
                    for (int j = 0; j < (int)cubemapSize; j++)
                    {
                        ...
                        img.SetPixel(i + (int)cubemapSize * 2, j,
                            new Color(pixelColor.r, pixelColor.g, pixelColor.b, pixelValue));
                    }
                }
                ...
                for (int i = 0; i < (int)cubemapSize; i++)
                {
                    for (int j = 0; j < (int)cubemapSize; j++)
                    {
                        ...
                        img.SetPixel(i + (int)cubemapSize * 3, j,
                            new Color(pixelColor.r, pixelColor.g, pixelColor.b, pixelValue));
                    }
                }
                ...
                for (int i = 0; i < (int)cubemapSize; i++)
                {
                    for (int j = 0; j < (int)cubemapSize; j++)
                    {
                        ...
                        img.SetPixel(i + (int)cubemapSize * 4, j,
                            new Color(pixelColor.r, pixelColor.g, pixelColor.b, pixelValue));
                    }
                }
                ...
                for (int i = 0; i < (int)cubemapSize; i++)
                {
                    for (int j = 0; j < (int)cubemapSize; j++)
                    {
                        ...
                        img.SetPixel(i + (int)cubemapSize * 5, j,
                            new Color(pixelColor.r, pixelColor.g, pixelColor.b, pixelValue));
                    }
                }
