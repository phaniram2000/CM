...
namespace Dreamteck.Splines
{
    ...
    public class TubeGenerator : MeshGenerator
    {
        ...
        [SerializeField] [HideInInspector] private float _uvTwist = 0f;
        ...
        void Generate()
        {
            ...
            for (int i = 0; i < sampleCount; i++)
            {
                ...
                for (int n = 0; n < _sides + 1; n++)
                {
                    ...
                    Quaternion rot =
                        Quaternion.AngleAxis(_revolve * anglePercent + rotation + 180f, evalResult.forward);
        ...
        void GenerateRoundCaps()
        {
            ...
            for (int lat = 1; lat < _roundCapLatitude + 1; lat++)
            {
                ...
                for (int lon = 0; lon <= sides; lon++)
                {
                    ...
                    Quaternion rot = Quaternion.AngleAxis(_revolve * anglePercent + rotation + 180f, -Vector3.forward) *
                    ...
                    Vector2 baseUV = new Vector2(anglePercent * uvScale.x - baseV * _uvTwist, baseV * uvScale.y) -
                                     uvOffset;
