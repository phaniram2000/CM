namespace Dreamteck.Splines
{
    ...
    public class ParticleController : SplineUser
    {
        ...
        [HideInInspector] public bool pauseWhenNotVisible = false;
        [HideInInspector] public Vector2 offset = Vector2.zero;
        [HideInInspector] public bool volumetric = false;
        [HideInInspector] public bool emitFromShell = false;
        [HideInInspector] public bool apply3DRotation = false;
        ...
        void HandleParticle(int index)
        {
                ...
                motionType == MotionType.None)
            {
                ...
                if (volumetric)
                {
                    ...
                    {
                        finalOffset += Vector2.Lerp(_controllers[index].startOffset, _controllers[index].endOffset,
                            1f - lifePercent);
        ...
        private void OnParticleBorn(int index)
        {
            ...
            double percent = 0.0;
            float emissionRate = Mathf.Lerp(_particleSystem.emission.rateOverTime.constantMin,
            ...
            switch (emitPoint)
            {
                ...
                case EmitPoint.Ordered:
                    percent = expectedParticleCount > 0 ? (float)_birthIndex / expectedParticleCount : 0f;
                    break;
            }
